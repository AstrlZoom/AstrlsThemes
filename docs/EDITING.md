...
- `build/my-discord-theme.css`: generated by the build script.
- `dist/my-discord-theme.theme.css`: generated single-file theme.
...
The easy bounce settings are in `themes/my-discord-theme.theme.css`:
...
Private GitHub repos are fine for saving your work, but Discord cannot load a private raw GitHub CSS URL without your login. For other people to install the online `themes/my-discord-theme.theme.css` import, the repo or hosted CSS file needs to be public.

The generated `dist/my-discord-theme.theme.css` file can still be installed manually because it contains everything in one file.
